...
function ensureModal() {
  ...
  o.innerHTML = `<div class="sc-modal"><button class="sc-close" id="sc-close" aria-label="Close">&times;</button><div class="sc-logo">🎬</div><div id="sc-body"></div></div>`;
...
function renderModal() {
  ...
  if (state.user) {
    ...
    document.getElementById("sc-portal").addEventListener("click", () => { closeModal(); portal(); });
