...
async function refresh() {
  ...
  // Let supabase-js process any OAuth response in the URL and persist it to
  // storage (needed on the sign-in landing page). Best-effort; ignore failures.
  try { const c = await client(); await c.auth.getSession(); } catch (e) {}
  // Decide auth state from the stored token directly, NOT from getSession.
